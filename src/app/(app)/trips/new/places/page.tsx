    ...
    return (
        <div className="flex flex-1 flex-col">
            ...
            <div className="flex flex-1 flex-col gap-6 px-5 pt-4 pb-6">
                ...
                <div className="relative h-48 overflow-hidden rounded-3xl bg-linear-to-br from-[#EAF2FE] to-[#E4FBF4]">
                ...
                <div className="mt-auto flex flex-col gap-3">
                    <Link
                        href="/trips/new/places/search"
                        className="flex w-full items-center justify-center gap-1.5 rounded-full bg-[#101828] py-3.5 text-center font-medium text-white"
                    >
                        가고 싶은 곳 담기
                    </Link>
                    <Link
